...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan  7 13:54:16 2018
...
if True:
    ...
    print('Série Pandas (como o index label não foi especificado, vai de 0 a N):')
    print(series)
...
if True:
    ...
    print('Série Pandas com index label especificado:')
    print(series)
...
if True:
    series = pd.Series(['Dave', 'Cheng-Han', 359, 9001],
                       index=['Instructor', 'Curriculum Manager',
                              'Course Number', 'Power Level'])
    print('Usando o index label para especificar elementos da série:')
    print(series['Instructor'])
    print('')
    print('Para especificar mais de um label, devemos usar uma lista Python:')
...
if True:
    cuteness = pd.Series([1, 2, 3, 4, 5], index=['Cockroach', 'Fish', 'Mini Pig',
                                                 'Puppy', 'Kitten'])
    print('Usando comparações lógicas para especificar elementos da Série:')
    print(cuteness > 3)
    print('')
